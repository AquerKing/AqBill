...
import 'package:bill/pages/data_page.dart';
...
Future<void> main() async {
  ...
  // 读取数据
  await TranscationRepository().updateTodaysRecords();
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider.value(value: TranscationRepository()),
      ],
      child: const MyApp(),
    ),
  );
...
class _AppHomeState extends State<AppHome> with SingleTickerProviderStateMixin {
  ...
  final List<Widget> _pages = [HomePage(), HistoryPage(), DataPage()];
      ...
      bottomNavigationBar: BottomNavigationBar(
        items: [
          ...
          BottomNavigationBarItem(
            ...
            label: AppLocalizations.of(context)!.bottomNavigatorBar_Data_Label,
          ),
        ],
      ...
      child: ListView(
        ...
        children: [
          ...
          ListTile(
            ...
            title: Text(localizations.appDrawer_AboutTextHint),
            onTap: () {
